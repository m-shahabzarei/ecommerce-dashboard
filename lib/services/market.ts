...
const products: MarketProduct[] = [
  {
    id: 1, name: "گوشی سامسونگ گلکسی S24", image: "", images: [], storeName: "تکنو پارس", inventory: 24, price: 48500000, supplierId: 1,
  ...
  {
    id: 2, name: "هدفون اپل ایرپادز پرو ۲", image: "", images: [], storeName: "دیجیتال سنتر", inventory: 56, price: 12800000, supplierId: 2,
  ...
  {
    id: 3, name: "لپ‌تاپ ایسوس VivoBook ۱۴", image: "", images: [], storeName: "کامپیوتر ایران", inventory: 12, price: 32400000, supplierId: 3,
  ...
  {
    id: 4, name: "ساعت هوشمند شیائومی", image: "", images: [], storeName: "گجت‌لند", inventory: 120, price: 3200000, supplierId: 4,
  ...
  {
    id: 5, name: "پاوربانک انکر ۲۰۰۰۰", image: "", images: [], storeName: "انرژی مدرن", inventory: 85, price: 1800000, supplierId: 5,
  ...
  {
    id: 6, name: "تبلت سامسونگ تب S9", image: "", images: [], storeName: "تکنو پارس", inventory: 8, price: 28900000, supplierId: 1,
  ...
  {
    id: 7, name: "مانیتور ال جی ۲۷ اینچ", image: "", images: [], storeName: "نمایشگر پلاس", inventory: 15, price: 15600000, supplierId: 6,
  ...
  {
    id: 8, name: "کیبورد مکانیکی ریزر", image: "", images: [], storeName: "گجت‌لند", inventory: 32, price: 9200000, supplierId: 4,
  ...
  {
    id: 9, name: "ماوس لاجیتک MX Master", image: "", images: [], storeName: "دیجیتال سنتر", inventory: 42, price: 7800000, supplierId: 2,
  ...
  {
    id: 10, name: "وب‌کم لاجیتک C920", image: "", images: [], storeName: "کامپیوتر ایران", inventory: 30, price: 4500000, supplierId: 3,
  ...
  {
    id: 11, name: "اسپیکر بلوتوثی JBL", image: "", images: [], storeName: "تکنو پارس", inventory: 18, price: 6200000, supplierId: 1,
  ...
  {
    id: 12, name: "هارد اکسترنال سامسونگ", image: "", images: [], storeName: "دیجیتال سنتر", inventory: 25, price: 11000000, supplierId: 2,
